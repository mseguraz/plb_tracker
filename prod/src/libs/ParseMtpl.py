...
class ParseMtpl(object):
                        ...
                        for region in hashPlistInfo[line[3]].keys():
                            ...
                            for flavor in hashPlistInfo[line[3]][region].keys():
                                ...
                                for phase in hashPlistInfo[line[3]][region][flavor].keys():
                                    ...
                                    #print("full info line",lineTotalInfo)
    ...
    def get_dutflow_items(self,flow,mtpl_file,regex):    
        ...
        hathplistInfo=self.plistInfo(listInstace) 
    ...
    def plistInfo (self,listInstace):
        ...
        for line in listInstace:
            ...
            if len(tuplesList) ==0:
                logging.info(" " * 20 + plistname +"plist is empty: " + instance)
    ...
    def extract_data(self,input_str):
        ...
        #print("data:",flavor,revision,scanRegion,masking )
        ...
        for p in plist:
                ...
                for i, pp in enumerate(plbs_list):
                    ...
                    # last element
                        ...
                        print(pp,'special case last plist has repeated plbs')
                    ...
                    #print("pat:",pp) 
                    #print("INFO",flavor, rev, region, phase, pp,p[0])
                    ...
                    if i==(len(plbs_list))-1:
                        ...
                        pp_list=[]
                        previous_mask=False
        # print("Debug Info",region,current_region,previous_region,flavor,previous_flavor)
